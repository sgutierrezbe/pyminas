            ...
            "lessons": [
                {
                    ...
                    "title": "¿Por qué iterar? Recorrido de secuencias con FOR",
                    "description": "Concepto de ciclo, repetición automática y recorrido de elementos en secuencias iterables.",
                    "duration": "8 min",
                    "steps": [
                        {
                            "type": "explanation",
                            ...
                            "intro": "En una planta de fundición, una cinta transportadora acerca lingotes de diferentes metales uno detrás de otro. En vez de escribir una orden para cada lingote a mano, el ciclo for toma automáticamente cada elemento de principio a fin.",
                            "examples": [
                                {
                            ...
                            "keyTakeaway": "La sintaxis for variable in coleccion: extrae secuencialmente cada elemento de la colección de principio a fin, ejecutando su bloque indentado una vez por cada elemento."
                        },
                        {
                            "type": "predict",
                            ...
                            "options": [
                                ...
                                },
                                {
                                    ...
                                    "text": "-M-I-N-A-S",
                                    "isCorrect": false,
                                    "whyIncorrect": "El guión se concatena después de cada letra (), no antes."
                                },
                                {
                                    "id": "C",
                                    "text": "M I N A S",
                        ...
                        },
                        {
                            ...
                            "intro": "En una subestación eléctrica, un sensor monitorea voltajes. Podemos colocar un condicional if dentro del for para alertar únicamente sobre las lecturas que superen el límite seguro.",
                            "examples": [
                                {
                                    "label": "Filtro de alto voltaje",
                                    "code": "voltajes = [110, 240, 115, 440]\nfor v in voltajes:\n    if v > 200:\n        print(f\"Alerta: {v}V\")",
                                    "output": "Alerta: 240V\nAlerta: 440V",
                                    "explanation": "Solo 240 y 440 superan el límite de 200V, ejecutando el bloque del if."
                                }
                            ],
                        ...
                        },
                        {
                            ...
                            "title": "Trazado con condicional",
                            "code": "numeros = [4, 15, 8, 23]\nfor n in numeros:\n    if n > 10:\n        print(n)",
                            "question": "Sigue mentalmente el recorrido de la lista. ¿Qué números imprimirá en consola este ciclo?",
                            "theory": "Revisa cuáles elementos de la lista cumplen estrictamente la condición n > 10.",
                            "options": [
                                {
                                    "id": "A",
                                    "text": "4\n8",
                            ...
                            "correctionTip": "Solo 15 y 23 cumplen n > 10. Imprime 15 y luego 23 en líneas separadas.",
                            "fullAnswerExplanation": "¡Muy bien analizado! El condicional n > 10 solo deja pasar a 15 y 23; los demás se descartan."
                        },
                        {
                            "type": "code_sandbox",
                            ...
                            "starterCode": "muestras = [\"hierro\", \"cuarzo\", \"oro\"]\n___ mineral ___ muestras:\n    print(\"Muestra:\", mineral)",
                            "slotMarker": "___",
                            "expectedOutput": "Muestra: hierro\nMuestra: cuarzo\nMuestra: oro",
                            "options": [
                                {
                                    "id": "A",
                                    "slots": [
                ...
                },
                {
                    ...
                    "title": "Memoria en Ciclos: Contadores y Acumuladores",
                    "description": "Variables externas al ciclo para llevar la cuenta (+= 1) y acumular sumatorias (+= valor).",
                    "duration": "9 min",
                    "steps": [
                        {
                            "type": "explanation",
                            "partLabel": "Paso 1 · El concepto",
                            "title": "El torniquete y la alcancía en acción",
                            "intro": "Un ciclo for repite código, pero sus variables internas cambian en cada vuelta. Para retener información a lo largo de las iteraciones, creamos variables ANTES del ciclo: un contador suma de 1 en 1, y un acumulador agrega montos variables.",
                            "examples": [
                                {
                            ...
                            "keyTakeaway": "Las variables acumuladoras y contadoras deben crearse ANTES del ciclo. Un contador suma un incremento constante (+= 1); un acumulador suma valores variables (+= valor)."
                        },
                        {
                            "type": "predict",
                            ...
                            "code": "piezas = 0\nlotes = [1, 1, 2]\nfor n in lotes:\n    piezas += n\nprint(piezas)",
                            "question": "¿Qué número imprimirá Python en la consola al finalizar este ciclo?",
                            "theory": "Rastrea el valor acumulado de piezas en cada iteración: 0 -> 1 -> 2 -> 4.",
                            "options": [
                                {
                                    "id": "A",
                                    "text": "3",
                            ...
                            "correctionTip": "Sigue la traza en cada vuelta: 0 + 1 = 1; 1 + 1 = 2; 2 + 2 = 4.",
                            "fullAnswerExplanation": "¡Correcto! La variable piezas arranca en 0 fuera del ciclo y acumula cada lote: 0 -> 1 -> 2 -> 4."
                        },
                        {
                            "type": "predict",
                            "partLabel": "Paso 3 · Spot the Bug",
                            ...
                            "theory": "Fíjate bien en qué líneas están dentro del bloque indentado del ciclo for.",
                            "options": [
                                {
                                    "id": "A",
                        ...
                        },
                        {
                            ...
                            "intro": "Para calcular el promedio de una serie de datos recolectados, combinamos los dos conceptos: la suma acumulada dividida entre el número de elementos contados al terminar el ciclo.",
                            "examples": [
                                {
